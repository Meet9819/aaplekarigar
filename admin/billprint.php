...
if (!isset($_SESSION["user"]["username"]) || $_SESSION["user"]["username"] !== "handicraft")    {
    die();
}
...
<body style="font-family: Helvetica Narrow, sans-serif; font-size: 14px;">
        ...
        <button id="print-btn" style="font-size: 2rem;" onclick="window.print();">Print Bill</button>
            ...
            <table  width='640' cellspacing='0' style='font-style:normal;font-weight:normal;font-stretch:normal;font-size:12px;line-height:16px;color:rgb(51, 51, 51);background-color:rgb(255, 255, 255);margin:0px auto;' cellpadding='0'>
                <tbody> 
                     ...
                     <tr>
                        <td colspan='2' rowspan='1' style='    background-color: #900f02;padding:0 20px 30px 20px;line-height:16px;width:640px;'>
                        </td>
                    </tr>
                     <tr>
                      ...
                      <tr>
                        <td colspan='2' rowspan='1' style='    background-color: #ffc460;padding:0 20px 10px 20px;line-height:10px;width:640px;'>
                        </td>
                    </tr>
                    <tr>  
                                    ...
                                    <tr>
                                        <td colspan='1' rowspan='1' style='text-align:left;width:490px;'>
                                            <span style='font-size:12px;font-weight:bold'> Order No #
                                                <a rel='nofollow' shape='rect' target='_blank' href='' style='text-decoration:none;color:#900f02;font-weight: bold;color:#1913a8'>     <?php echo $bill_no; ?></a>
                                            </span> <br><span style='font-size:12px;font-weight:bold'> Invoice No #
                                                <a rel='nofollow' shape='rect' target='_blank' href='' style='text-decoration:none;color:#900f02;font-weight: bold;color:#1913a8'>     <?php echo $invoiceno; ?></a>
                                            </span> 
                                        </td>
                                    </tr>
                                </tbody>
  ...
  <tr> 
                       <td colspan='1' rowspan='1' valign='top' style='font-style:normal;font-weight:normal;font-stretch:normal;font-size:14px;line-height:normal;padding:11px 26px 14px;width:280px;'>
                                        ...
                                        <strong> Aaple Karigar                                        <br clear='none'> 
										
										Poonam Complex, CHS Limited, Miraroad (E), <br clear='none'> Thana - 401 107
                                        <br clear='none'>Customer Care - +91 93245 50502 / +91 83558 14532
                                        <br>Email Id - aaplekarigar@gmail.com <br> 
                    ...
                    <tr>  
                        <td colspan='2' rowspan='1' style='width:640px;'>
                            <p style='font-style:normal;font-weight:bold;font-stretch:normal;font-size:18px;line-height:normal;color:#900f02;margin:0px 20px 0px;'>Hello     <?php
                                        echo  $customer_info["userName"]; ?> ,</p>
                            <p style='margin:4px 0px 4px 20px;width:640px;font-size:16px;    line-height: 21px;
    font-style: italic;
    font-weight: bold;'>Thank You for choosing Aaple Karigar Your order is on the way by <Br> Delivery Boy : <?php echo $deliveryboy; ?>.  </p>  
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <br clear='none'>  ".$customer_info["address"]."  <br> Pin Code: " . $customer_info["pincode"]." , India </strong>.
											 ...
											 <br clear='none'><span style='color:#900f02;font-weight:bold'> Transaction Id - ".$paymentid."</span>";
                                            ...
                                            <table id='example' class='table table-striped table-bordered display' >
                                                <thead>
                                                    <tr>  <th style='text-align:left;color:white'>SR.</th>
														...
														<th style='text-align:left;color:white'>GP Price</th>
...
">
                ...
                while ($row = mysqli_fetch_array($result)) {                      
						...
						//$totalafteryousavee+= $totalafteryousave; 
                                                           ...
                                                           echo " <tr>
                                                            ...
                                                            <tr style="    background-color: #ffce51;    color: white;"> 
                                                               <td></td>  
																<td></td> 
                                                                <td></td>
																...
																<td></td>
                                                                <td><?php echo '<B>&#8377;'.$finalamounttwithoutship.'</b>' ?></td>    
                                                                <td></td>
                                                            </tr>
                                            </table>
                                        </td>
	...
	echo "
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        <td align='right'  colspan='2' rowspan='1' valign='top' style='text-align:right;font-style:normal;font-weight:normal;font-stretch:normal;font-size:15px;line-height:18px;padding:0px 10px 0px 0px;color:rgb(51, 51, 51);width:480px;'>Discount :</td>
                                        <td align='right' colspan='1' rowspan='1' valign='top' style='text-align:right;font-style:normal;font-weight:normal;font-stretch:normal;font-size:15px;line-height:18px;color:rgb(51, 51, 51);width:85px;'>&#8377; $discount.00</td>
                                    </tr>
                     ...
                     <tr>
                        <td colspan='2' rowspan='1' style='padding:0 20px 0 20px;line-height:22px;width:640px;'>
                               <p style='border-top:1px solid #ccc;padding:20px 0 0 0;'>Track your order with the <a rel='nofollow' shape='rect' target='_blank' href='' style='color:#900f02;text-decoration:none;'><b>Aaple Karigar</b></a>.
                     ...
                     <tr>
                        ...
                        <tr>
                        <td colspan='2' rowspan='1' >
                         <img width="30px" src="http://aaplekarigar.in/admin/a.png">---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                         </td>
                    </tr>
