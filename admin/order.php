		...
		<div class="row small-spacing">
			...
			include('db.php');
                ...
                <?php
                    ...
                    $result = mysqli_query($con,"SELECT p.id as id, p.status as status, p.billno,p.name,p.email,p.phone,p.product_price,p.product_name,p.paymentid,p.address,p.productcode,p.created,p.modeofpayment,p.paymentid FROM payment p  where p.paymentid != ''"); 
                     $tmpCount = 1;
