					...
					<table id="example" class="table table-striped table-bordered display" style="width:100%">
						...
						<tbody>
									...
									/* code for data delete */
											...
											$result = mysqli_query($con,"SELECT p.id, p.maincat,p.categoryid,p.productcode,p.name,p.description,p.img,p.status, p.stock, m.menu_name from products p, menu m where p.maincat = m.menu_id"); 
  ...
  <button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#customer2"><i class="fa fa-trash-o"></i> </button>
       ...
       <br>
        <br>
         ...
         <a href="productprice.php?edit_id='.$row['id'].'" >
   

   	  <span class=" btn-sm btn-warning" data-toggle="modal" data-target="#customer2">Add Price </span>	
   			 </a>
  </td>
