                ...
                <div class="container-fluid">
                    <div class="breadcrumb-content text-center border-top-2">
                      ...
                      <?php
                        ...
                        echo '
                              <h1 style="    color: #c51406;font-size:26px">'.$row['menu_name'].'</h1>
                        ...
                        <div class="col-md-12">
                            <div class="shop-topbar-wrapper">
                                ...
                                <div class="shop-filter">
                                    ...
                                    $result = mysqli_query($con,"SELECT COUNT(*) as counting FROM products WHERE ( categoryid=$pr_id or maincat = $pr_id ) and status = 1 ");
                                    while($row = mysqli_fetch_array($result))
                                    {
                                 ...
                                 if(isset($_POST['search']))
                                    {
                                     ...
                                     $result = mysqli_query($con,"SELECT * FROM products WHERE name LIKE '%".$name."%' and status = 1 order by name ASC");
                                    }
                                     else {                        
                                    $result = mysqli_query($con,"SELECT * FROM products WHERE status = '1' and (categoryid=$pr_id or maincat = $pr_id ) order by name ASC");
                                    }
